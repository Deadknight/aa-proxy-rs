...
fn choose_bt_sco_microphone_source(msg: &ServiceDiscoveryResponse) -> Option<(u8, AudioStreamConfig, i32)> {
    ...
    for svc in msg.services.iter() {
        ...
        let call_score = if source.available_while_in_call() { 0 } else { 5 };
