...
pub fn wasm_script_limits_config_section() -> ConfigValues {
    ...
    values.insert(
        ...
        ConfigValue {
            typ: "integer".to_string(),
            description: "Maximum number of memories allowed inside each WASM script store. Default: 4.".to_string(),
            values: None,
        },
    );
    values.insert(
        ...
        ConfigValue {
            typ: "integer".to_string(),
            description: "Maximum number of tables allowed inside each WASM script store. Default: 8.".to_string(),
            values: None,
        },
    );
    values.insert(
...
impl AppConfig {
    ...
    pub fn save(&self, config_file: PathBuf) {
        ...
        doc["wasm_script_table_elements_limit"] = value(self.wasm_script_table_elements_limit as i64);
        doc["wasm_script_packet_epoch_deadline"] = value(self.wasm_script_packet_epoch_deadline as i64);
        doc["wasm_script_lifecycle_epoch_deadline"] = value(self.wasm_script_lifecycle_epoch_deadline as i64);
